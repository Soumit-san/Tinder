...
ASPECT_KEYWORDS = {
    'UI/UX': [
        'interface', 'design', 'layout', 'navigation', 'simple', 'confusing',
        'ui', 'ux', 'screen', 'button', 'menu', 'theme', 'dark mode', 'look',
        'beautiful', 'ugly', 'clean', 'cluttered', 'intuitive', 'user friendly',
    ],
    'Pricing': [
        'price', 'subscription', 'premium', 'gold', 'expensive', 'free', 'cost',
        'refund', 'pay', 'money', 'charge', 'billing', 'plan', 'worth', 'cheap',
        'overpriced', 'paid', 'purchase', 'tinder plus', 'tinder gold', 'platinum',
    ],
    'Matches': [
        'match', 'like', 'algorithm', 'profile', 'swipe', 'boost', 'super like',
        'connection', 'date', 'partner', 'compatible', 'suggestion', 'recommend',
        'discover', 'passport', 'explore',
    ],
    'Bugs': [
        'crash', 'bug', 'glitch', 'slow', 'freeze', 'load', 'error', 'fix',
        'update', 'broken', 'laggy', 'stuck', 'unresponsive', 'not working',
        'force close', 'hang', 'lag',
    ],
    'Safety': [
        'fake', 'bot', 'scam', 'privacy', 'data', 'report', 'block', 'verify',
        'catfish', 'spam', 'harassment', 'safety', 'secure', 'identity',
        'verification', 'real', 'genuine', 'suspicious',
    ],
}
